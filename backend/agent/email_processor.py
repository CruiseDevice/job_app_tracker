...
"""
            ...
            # LLM prompt for job application analysis - ONLY tracking specific follow-up types
            prompt = """
You are an AI assistant that analyzes emails to detect specific types of job-related communications.

IMPORTANT: Only track emails that are FOLLOW-UPS related to interviews, assessments, or screening calls. 
...
{{
    ...
    "status": "interview/assessment/screening",
    "description": "Brief description of the follow-up",
    "salary": "Salary range (if mentioned)",
    "job_url": "Job posting URL (if available)",
    "application_date": "Date of original application (YYYY-MM-DD format)",
    "notes": "Additional relevant information about the follow-up"
}}

Only return valid JSON. If it's not a follow-up email for interview/assessment/screening, set "is_job_application" to false.
...
- Offer letters (unless they specifically follow an interview/assessment)

Status mapping (ONLY these three):
