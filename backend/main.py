...
from api.routes import applications, monitor, settings, statistics, jobs_capture, agents, monitoring, job_matching
...
app.include_router(job_matching.router, prefix="/api", tags=["job_matching"])
